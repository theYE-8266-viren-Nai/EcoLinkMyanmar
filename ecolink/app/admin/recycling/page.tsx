...
import type { AdminRouteRequestList } from "@/features/recycling-routes/types";
...
export default async function AdminRecyclingRoutePage() {
  ...
  try {
    ...
    initialRequests = await service.listAdminRequests();
  } catch (error) {
  ...
  return <AdminRecyclingPage initialError={initialError} initialRequests={initialRequests} />;
}
